...
@Getter
@GroupSequence({CategoryUpdate.class, CategoryParentFirstCheck.class, CategoryParentSecondCheck.class})
...
public class CategoryUpdate {
    ...
    @JsonCreator
    CategoryUpdate(@JsonProperty String name, @JsonProperty Long parentId) {
        this.name = name;
