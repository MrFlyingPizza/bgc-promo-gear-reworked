...
import com.example.bgcpromogearreworked.api.products.persistence.OptionValueId;
import com.example.bgcpromogearreworked.api.products.persistence.OptionValueRepository;
...
public class OptionValueExistsValidator implements ConstraintValidator<OptionValueExists, Object> {
    ...
    public boolean isValid(Object o, ConstraintValidatorContext constraintValidatorContext) {
        ...
        if (productId == null || optionName == null || optionValue == null) {
            return false;
        }
